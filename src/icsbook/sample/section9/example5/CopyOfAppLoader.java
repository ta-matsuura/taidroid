...
//    }
    ...
    public static class AppListLoader2 extends AsyncTaskLoader<List<AppEntry>> {

        final PackageManager mPackageManager;

        public AppListLoader2(Context context) {
            super(context);
...
//            boolean configChange = mLastConfig.applyNewConfig(getContext().getResources());
            ...
            // アプリデータが変わっている、もしくは、アプリデータがまだ読まれていない
            // もしくは、コンフィグレーションが変更されている場合
