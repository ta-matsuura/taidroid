...
public class StackWidgetService extends RemoteViewsService {
    ...
    public RemoteViewsFactory onGetViewFactory(Intent intent) {
        ...
        return new StackRemoteViewFactory(this.getApplicationContext(), intent, data);
    }
    ...
    class StackRemoteViewFactory implements RemoteViewsService.RemoteViewsFactory {
        ...
        public StackRemoteViewFactory(Context context, Intent intent, List<WidgetItem> data) {
            mContext = context;
            mData = data;
        }
        ...
        public RemoteViews getViewAt(int position) {
            // StackWidget の子 View に表示する RemoteViews を取得
            RemoteViews views = new RemoteViews(mContext.getPackageName(), R.layout.stackwidget_item);
