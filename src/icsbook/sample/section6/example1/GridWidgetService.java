...
public class GridWidgetService extends RemoteViewsService {
    ...
    public RemoteViewsFactory onGetViewFactory(Intent intent) {
        ...
        return new GridRemoteViewFactory(this.getApplicationContext(), intent, data);
    }
    ...
    class GridRemoteViewFactory implements RemoteViewsService.RemoteViewsFactory {
        ...
        public GridRemoteViewFactory(Context context, Intent intent, List<WidgetItem> data) {
            mContext = context;
            mData = data;
        }
        ...
        public RemoteViews getViewAt(int position) {
            // GridView の子 View に表示する RemoteViews を取得
            RemoteViews views = new RemoteViews(mContext.getPackageName(), R.layout.gridwidget_item);
            ...
            fillInIntent.putExtra(GridWidgetProvider.EXTRA_ITEM, position);
